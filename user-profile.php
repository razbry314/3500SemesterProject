            ...
            <div class="well well-sm">
                <div class="row">
                    <div class="col-sm-6 col-md-4">
                        <img src="images/avatar_<?php echo $_SESSION['Avatar'];?>.png" alt="" class="img-rounded img-responsive" />
                    </div>
                    <div class="col-sm-6 col-md-8">
                        ...
                        <p>
                            <i class="glyphicon glyphicon-envelope"></i><?php echo $_SESSION['EmailAddress']; ?>
                            <br />
